...
// Datos completos de los tests (15 preguntas cada uno)
const testsData = [
  {
  ...
  },
  {
    ...
    questions: [
      ...
      { text: '¿Tu estado de ánimo fluctúa drástically based on affection?', options: likert() },
      { text: '¿Te sientes responsable de la felicidad y bienestar de tu pareja?', options: likert() },
